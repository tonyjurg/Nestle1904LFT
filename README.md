...
Attribution: "MACULA Greek Linguistic Datasets, available at https://github.com/Clear-Bible/macula-greek/". See [here](docs/docs/legal.md#readme) for licence of the source data.
