...
[wglevel](wglevel.md#start) | [`Node`](featuresbyfeaturetype.md#node-features)  | [`string`](featuresbydatatype.md#string-datatype) | Number of the parent wordgroups for a wordgroup | `5` `10`
