...
[booknumber](booknumber.md#readme) | [`Node`](featuresbyfeaturetype.md#node-features) | `integer`  |  [`word`](featuresbynodetype.md#word-nodes) [`book`](featuresbynodetype.md#book-notes) | NT book number (Matthew=1, ... , Revelation=27) | `3` `8`
