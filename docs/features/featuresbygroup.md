...
[wglevel](wglevel.md#start) | [`Node`](featuresbyfeaturetype.md#node-features)  | [`string`](featuresbydatatype.md#string-datatype) | [`wg`](featuresbynodetype.md#wordgroup-nodes) | Number of the parent wordgroups for a wordgroup | `5` `10`
